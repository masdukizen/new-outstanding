...
import columnsSupplier from "./supplier_columns";
      ...
      <div className="rounded-md border">
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              <TableRow>
                <TableCell colSpan={columnsSupplier.length} className="h-24">
                  <div className="flex space-x-4">
                    {Array(columnsSupplier.length)
                      .fill(0)
                      .map((_, index) => (
                  ...
                  {row.getVisibleCells().map((cell) => {
                    ...
                    return (
                      <TableCell
                        key={cell.id}
                        style={
                          ["name", "address", "pic_name"].includes(columnId)
                            ? {
                                width: "250px",
                                minWidth: "200px",
                                maxWidth: "400px",
