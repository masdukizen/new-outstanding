...
export const monitoringColumns: ColumnDef<Po>[] = [
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="text-center">
          <Link
            href={`/monitoring/${po.id}`}
            onClick={() => {
              sessionStorage.setItem("monitoringData", JSON.stringify(po));
            }}
            ...
            <TooltipProvider delayDuration={100}>
              <Tooltip>
                <TooltipTrigger>
                  <FileSearch
                    size={25}
                    className="border p-1 border-blue-500 hover:bg-blue-500 hover:text-white rounded-sm"
                  />
                </TooltipTrigger>
                <TooltipContent>
                  <p>Detail</p>
